      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={() => setMethod('stripe')} className='flex items-center gap-3 border-1 border-gray-200 p-2 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3.5 border-1 border-gray-200 rounded-full ${method === 'stripe' ? 'bg-green-400 ' : ''}`}></p>
              <img src={assets.stripe_logo} className='h-5 mx-4 ' alt="" />
            </div>

            <div onClick={() => setMethod('razorpay')} className='flex items-center gap-3 border-1 border-gray-200 p-2 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3.5 border-1 border-gray-200 rounded-full ${method === 'razorpay' ? 'bg-green-400 ' : ''}`}></p>
              <img src={assets.razorpay_logo} className='h-5 mx-4 ' alt="" />
            </div>

            <div onClick={() => setMethod('cod')} className='flex items-center gap-3 border-1 border-gray-200 p-2 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3.5 border-1 border-gray-200 rounded-full ${method === 'cod' ? 'bg-green-400 ' : ''}`}></p>
